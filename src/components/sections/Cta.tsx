...
export default function Cta() {
  ...
  return (
    <section className="cta pad" id="join">
      ...
      <canvas ref={canvasRef} id="cta-canvas" aria-hidden="true" />
      <div className="wrap">
        ...
        <h2 data-reveal>
          ...
          <span className="coral-word">three days too late.</span>
        </h2>
        <p className="sub" data-reveal>
          Join the waitlist. First 50 teams get 3 months of Pro free.
        </p>
        <div data-reveal>
          <WaitlistForm />
        </div>
